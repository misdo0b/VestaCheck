    ...
    <div className={`mb-12 ${isLocked ? 'opacity-75' : ''}`}>
      ...
      <div className="space-y-4 px-2">
        {fields.map((field, index) => (
          ...
          >
            <div className="flex-1 w-full">
              <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">{t('inspection.keyType')}</label>
              <div className="relative">
                ...
                <input 
                  ...
                  placeholder={t('inspection.keyTypePlaceholder')}
            ...
            <div className="w-full md:w-32">
              <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">{t('pdf.keyCount')}</label>
              <input 
                type="number"
        ...
        {!isLocked && (
          ...
          >
            <Plus size={18} /> {t('inspection.addAccessBtn')}
          </button>
        )}
      </div>
    </div>
